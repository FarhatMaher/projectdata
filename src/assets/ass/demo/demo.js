...
demo = {
  ...
  showSwal: function(type, msg , id , idv) {
    if (type == 'basic') {
      swal({
      ...
      swal({
        ...
        verifdelete = true ;
        alert(id + idv);
       /* $.post('BaseURL + /ad/deletee',   // url
        { id: id , idv: idv  }, // data to be submit
        function(response, status) {// success callback
          return true ;
       });*/
...
return verifdelete;
  ...
  showNotification: function(from, align) {
    ...
    $.notify({
      ...
      message: "Bienvenue à <b>Echri Terba7 </b> - Achetez et vendez près de chez vous en Tunisie."
